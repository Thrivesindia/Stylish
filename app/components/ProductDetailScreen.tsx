...
// // Sample data for similar products (same as the previous code)
...
//     color: '#d63653',
//   },
//   // Styles for the Similar To Section
//   similarSection: {
//     marginTop: 10,
//   },
//   similarHeader: {
...
const ProductDetailScreen: React.FC<Props> = ({ route }) => {
  ...
  const handleAddToCart = () => {
    ...
    navigation.navigate('CartScreen', { cartItems: [...cartItems, cartItem] });
  };
